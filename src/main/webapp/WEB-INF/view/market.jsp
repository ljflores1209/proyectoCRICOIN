...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/css/Header-Blue.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/css/Header-Dark.css">
...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/css/Navigation-Clean.css">
<link rel="stylesheet"
...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/css/market.css">
...
<body>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navcol-1">
				...
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item"></li>
					<li class="nav-item"><a class="nav-link"
						href="./controller?accion=recuperarDatosCartera">Cartera</a></li>
					<li class="nav-item"><a class="nav-link" href="${linkProfile}">Perfil&nbsp;
	...
	<div class="container-fluid">
		<!-------------------------------mensaje bienvendida------------------------------>
		<h1
			style="text-align: center; font-size: 33px; padding: 34px; font-weight: bolder;">MERCADO</h1>
		...
		<div class="row">
			<div class="col-md-9">
				<!-- extra1 -->
				<div
					style="height: 560px; background-color: #FFFFFF; overflow: hidden; box-sizing: border-box; border: 0px solid #56667F; border-radius: 4px; text-align: right; line-height: 14px; font-size: 12px; font-feature-settings: normal; text-size-adjust: 100%; padding: 1px; padding: 0px; margin: 0px; width: 100%;">
				...
				<div class="mercbox pb-3" style="background-color: #FFDF08">
					...
					<div class="tab-content">
						...
						<div class="tab-pane container active" id="compra">
							<div class="mt-5">
								<form action="./controller?accion=comprar" method="post"
									name="myForm" id="idMyform"
									onsubmit="return validateValorCompra()"
									...
									<label>Cantidad de compra:&nbsp;</label> <input
										class="form-control" id="conversion" name="conversion"
										readonly type="number" value="0">

									<div class="mb-4">
										<span id="cartera">Valor COIN</span>
									</div>

									<label>Valor de compra:&nbsp;</label> <input
										class="form-control" id="apuesta" name="apuesta" type="number"
									...
									<div class="mt-2">
										<button type="submit" class="btn  btn-block mt-2 comVen">Comprar</button>
									</div>
								</form>
						...
						<div class="tab-pane container fade" id="venta">
							<div class="mt-5">
								<form action="./controller?accion=vender" method="post"
									name="myFormVenta" id="idMyformVenta"
									onsubmit="return validateValorVenta()"
									style="margin-bottom: 10px; text-align: left; margin-top: 10px;">
									<div class="input-group mb-3">
										<div class="input-group-prepend">
									...
									<label>Valor de venta:&nbsp;</label> <input
										class="form-control" id="conversionVenta"
										name="conversionVenta" readonly type="number" value="0">
									<!-- aqui va lo que ganare en dolares con la venta por la cantidad de coin que pongo abajo -->

									<div class="mb-4">
										<span id="precioCoin" />Valor COIN</span>
									</div>
									<!-- aqui va el precio del dolar contra la moneda -->


									<label>Cantidad de venta:&nbsp;</label> <input
										class="form-control" id="apuestaVenta" name="apuestaVenta"
										type="number" value=" " placeholder="Introduce la cantidad...">
									<!-- aqui elijo cuanta coin quiero vender "apuesta" en caso compra -->

									<div class="mb-4">
										<span id="carteraVenta"></span><span id="coinVenta">COINs
											en haber</span>
									</div>
									<!-- aqui va la cantidad de la moneda seleccionada que tengo -->


									<div class="mt-2">
										<button type="submit" class="btn  btn-block mt-2 comVen">Vender</button>
									</div>
								</form>
							</div>
		...
		<div class="row">
			...
			<div class="col-md-2">
				<div class="mercado-coin-conversor "
					...
					<div>
						<h4 class="text-center font-weight-bold  mt-1">Cambios</h4>
					</div>
					<div style="height: 413px; padding: 0px; margin: 0px; width: 100%;">
						<iframe
